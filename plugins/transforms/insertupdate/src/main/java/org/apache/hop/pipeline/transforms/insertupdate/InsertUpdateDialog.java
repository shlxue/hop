...
public class InsertUpdateDialog extends BaseTransformDialog {
  ...
  private Button wFixConflictKey;
  ...
  public String open() {
    ...
    wlFixConflict.setText(BaseMessages.getString(PKG, "InsertUpdateDialog.FixConflict.Label"));
    PropsUi.setLook(wlUpdateBypassed);
    ...
    wFixConflictKey = new Button(shell, SWT.CHECK);
    PropsUi.setLook(wUpdateBypassed);
    ...
    wFixConflictKey.setLayoutData(fdFixConflict);
    wFixConflictKey.addSelectionListener(new ComponentSelectionListener(input));
    ...
    fdlErrCodeField.top = new FormAttachment(wFixConflictKey, margin);
    ...
    fdErrCodeField.top = new FormAttachment(wFixConflictKey, margin);
    ...
    wlErrMessageField.setText(
        BaseMessages.getString(PKG, "InsertUpdateDialog.ErrMessageField.Label"));
  ...
  public void getData() {
    ...
    wFixConflictKey.setSelection(input.isFixConflictKey());
  ...
  private void getInfo(InsertUpdateMeta inf) {
    ...
    inf.setFixConflictKey(wFixConflictKey.getSelection());
