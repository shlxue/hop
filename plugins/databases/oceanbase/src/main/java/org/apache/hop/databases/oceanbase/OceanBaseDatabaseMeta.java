...
package org.apache.hop.databases.oceanbase;
...
/** Contains OceanBase specific information through static final members */
@DatabaseMetaPlugin(
    type = "OCEANBASE",
    typeDescription = "OceanBase",
    documentationUrl = "/database/databases/oceanbase.html")
@GuiPlugin(id = "GUI-OceanBaseDatabaseMeta")
public class OceanBaseDatabaseMeta extends BaseDatabaseMeta {
  private static final Class<?> PKG = OceanBaseDatabaseMeta.class;
  public static final String CONST_MYSQL_8 = "OceanBase 2+";

  private boolean oracleMode;
  private final IDatabase raw;
  ...
  public OceanBaseDatabaseMeta() {
    super();
    oracleMode = false;
    raw = oracleMode ? new OracleDatabaseMeta() : new MySqlDatabaseMeta();
  }
  ...
  //      Sets.newHashSet("com.mysql.jdbc.PacketTooBigException",
  ...
  public String getLimitClause(int nrRows) {
    return raw.getLimitClause(nrRows);
  }
  ...
  public String getURL(String hostname, String port, String databaseName) {
    if (Utils.isEmpty(port)) {
      return "jdbc:oceanbase://" + hostname + "/" + databaseName;
    } else {
      return "jdbc:oceanbase://" + hostname + ":" + port + "/" + databaseName;
    }
  }
  ...
  public String getExtraOptionsHelpText() {
    return "https://en.oceanbase.com/docs/common-oceanbase-connector-j-en-10000000000380851";
  }
  ...
  //    return "insert into " + schemaTable + "(" + keyField + ", " + versionField + ") values (1,
  // 1)";
  //  }
  //
  //  /**
  //   * @param string
  //   * @return A string that is properly quoted for use in a SQL statement (insert, update,
  // delete,
  //   *     etc)
  //   */
  //  @Override
  ...
  //
  //  /**
  //   * @return true if the database is a MySQL variant, like MySQL 5.1, InfiniDB, InfoBright, and
  // so
  //   *     on.
  //   */
  //  @Override
  ...
  //
  //  /**
  //   * Returns the column name for a MySQL field checking if the driver major version is "greater
  //   * than" or "lower or equal" to 3.
  //   *
  //   * @param dbMetaData
  //   * @param rsMetaData
  //   * @param index
  //   * @return The column label if version is greater than 3 or the column name if version is
  // lower or
  //   *     equal to 3.
  ...
  //   */
  //  public List<String> getDriverClassNames(ILogChannel log, IHopMetadataProvider
  // metadataProvider) {
